...
int main ()
{
  ...
  uint32_t size;
  int yes = 1;
  char config_buffer[8] = {0};
	
  printf("%d %d %d %d %d %d %d %d",
		  fetched_config.width_reset,
		  fetched_config.ram_writer_reset,
		  fetched_config.CIC_divider,
		  fetched_config.ram_writer_input,
		  fetched_config.f_out,
		  fetched_config.f_out2,
		  fetched_config.mult0,
		  fetched_config.mult1);
